 ...
 *
 * Proxies Clerk Frontend API requests through the deployment domain so Clerk
 * can safely serve custom domains without browser-side secret handling.
 */
  ...
  return (req, res, next) => {
    ...
    if (!proxy) {
      ...
      proxy = createProxyMiddleware({
        target: process.env.CLERK_FAPI_URL || CLERK_FAPI,
        changeOrigin: true,
