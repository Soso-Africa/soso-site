...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Selecting Custom means your garment will be made to your personal measurements. After payment, the atelier will contact you to collect the measurements required for your specific piece.",
  },
  {
    id: "stylist-help",
    category: "Sizing",
  ...
  },
  {
    ...
    answer:
      "If you need to change any details after payment, contact the SOSO atelier as soon as possible through the support enquiry form. Because garments are made to order and production begins quickly after payment, changes may not always be possible once making has started.",
  },
  {
    id: "care-guide",
    category: "Care",
    ...
    answer:
      "Most SOSO garments should be hand-washed or gently machine-washed in cool water, then line-dried away from direct sunlight. Iron on a cool or medium setting, and store folded rather than hung to preserve the shape. The atelier will advise on your specific garment after your order is confirmed.",
  },
  {
    id: "what-is-bespoke",
    category: "About SOSO",
    ...
    answer:
      "Every SOSO piece is made specifically for the person who orders it. Nothing is taken from a production rack. The atelier confirms details, finish preferences, and where necessary measurements after each payment.",
  },
  {
