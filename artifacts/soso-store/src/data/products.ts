 ...
 * JusticeSure adapter: live price, production options, variants and product facts must
...
export const products: CatalogProduct[] = [
  ...
  { slug: "sovereign-agbada", name: "The Sovereign Agbada", img: "/images/soso/agbada.jpg", price: 480000, tag: "Occasion", note: "A three-piece agbada statement", category: "Agbadas", description: "A three-piece agbada for grand occasions. After payment, the atelier confirms requested finish and production timing.", sizes: ["S","M","L","XL","XXL","Custom"] },
