-- Generated from the last SOSO Drizzle schema before migrations 0001-0004.
-- Used only to prove that the standard migration command upgrades a real
-- legacy schema without relying on the fresh-database baseline.
...
CREATE TYPE "soso_staff_role" AS ENUM('owner', 'operations', 'stylist', 'editor', 'analyst');
